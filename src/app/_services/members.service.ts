...
export class MembersService {
  ...
  getMember(username: string) {
    console.log(this.memberCatch.values())
    const member = [...this.memberCatch.values()].reduce((arr, elem) => arr.concat(elem.result), []).find((member: Member)=> member.userName === username);
